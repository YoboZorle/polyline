...
import 'package:polyline/model/route.dart';
import 'package:polyline/network/networ_util.dart';
...
class MapUtil implements GpsUtilListener {
  ...
  init() {
    ...
    gpgUtils.init();
    staticMapProvider = new StaticMapProvider("AIzaSyAPV3djPp_HceZIbgK4M4jRadHA-d08ECg");
  }
